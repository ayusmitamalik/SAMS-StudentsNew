...
import style from "../../../common/css/faculty/ele.module.css";
import FacultyPage from "../sidebar";
import ele1 from "../../../common/image/saisriya1.jpg";
import ele2 from "../../../common/image/riti.jpg";
import ele3 from "../../../common/image/lulu.jpg";
import ele4 from "../../../common/image/puja.jpg";
...
function ElePage() {
    return (
        <>
            ...
            <div className={style.heading}><h2>ELECTRICAL ENGINEERING</h2></div>
